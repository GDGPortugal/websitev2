...
export default function CommunityCards() {
  return (
    <div id="comunidades" className="mt-20 p-8">
            ...
            <div className="bg-blue-500 rounded-3xl p-8 text-white relative overflow-hidden h-[500px] flex flex-col">
              <div className="flex-1">
                ...
                <p className="text-blue-100 leading-relaxed">
                  Cada comunidade GDG em Portugal é única, com seu próprio ritmo, eventos e
                  talentos. Conheça os grupos locais e descubra como participar.
                </p>
              </div>
              <div className="mt-8">
            ...
            <div className="bg-yellow-400 rounded-3xl p-8 text-white relative overflow-hidden h-[500px] flex flex-col">
              <div className="flex-1">
                ...
                <p className="text-yellow-100 leading-relaxed">
                  Deixe-se inspirar por palestras instigantes, oficinas e oportunidades de
                  networking. Desbloqueie novas oportunidades.
                </p>
              </div>
              <div className="mt-8">
                <div className="bg-white rounded-2xl p-4 shadow-lg">
